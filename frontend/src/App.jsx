  ...
  return (
    <div className="min-h-screen bg-gray-800 flex justify-center items-center p-4">
      <div className="bg-gray-50 rounded-2xl shadow-xl w-full max-w-lg p-8">
        <h1 className="text-4xl font-bold text-gray-800">EMAM TODO APP</h1>
        {error && (
                  ...
                  {editingTodo === todo.todo_id ? (
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-x-2">
                        ...
                        }} className="p-2 text-blue-500 hover:text-blue-700 rounded-lg hover:bg-blue-50 durartion-200">
                          <MdModeEditOutline />
                        </button>
                        <button
                          onClick={() => deleteTodo(todo.todo_id)} 
                        className="p-2 text-red-500 hover:text-red-700 rounded-lg hover:bg-red-50 duration-200"> <FaTrash /> </button>
                      </div>
                    </div>
